...
/**
 * The Class ProfessorePanel.
 */
public class ProfessorePanel extends JPanel {

    /** The Constant serialVersionUID. */
    private static final long serialVersionUID = -7684918388904038528L;
     ...
     * @param name the name
     */
    public ProfessorePanel(final SwingApplicationContext applicationContext, final Properties properties, final String name) {
        super();
